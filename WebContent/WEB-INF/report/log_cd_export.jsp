					...
					<div id="layout-container" style="width: 100%; height: 100%;">
						...
						<div class="ui-layout-center">
							<div id="panel-list" class="panel panel-default">
								...
								<div class="panel-heading">
									<span class="title elipsis">
										<strong>CD반출로그</strong> <!-- panel title -->
									</span>
								</div>
 		...
 		if (jQuery().dataTable) {
			...
			table.dataTable({
			    ...
			    "buttons": [
				                  ...
				                  bom: true,
				                  exportOptions: {
					                columns: [1,2,3,4,7,10,11,12,13,16,18],
				                      modifier: {
				                          search: 'applied',
				                          order: 'applied'
				                      }
				...
				{	
					...
					,"class" : "center-cell"
						,"render": function(data,type,row){
							...
							return '<i title="상세보기" class="fa fa-search" aria-hidden="true" onclick="javascript:FileDetail('+ row.exportNo + ', \'cd_export_log\',\''+ encodeURI(row.fileId) +'\')">' + fileName;
