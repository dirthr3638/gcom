...
<html lang="utf-8">
	...
	<body>
		...
		<div id="wrapper" class="clearfix">
			...
			<% request.setAttribute("menu_sub_first", 5400); %> 
					...
					<div id="layout-container" style="width: 100%; height: 100%;">
						...
						<div class="ui-layout-center">
							<div id="panel-list" class="panel panel-default">
								...
								<div class="panel-heading">
									<span class="title elipsis">
										<strong>네트워크반출로그</strong> <!-- panel title -->
									</span>
								</div>
												...
												<table id="user" class="table table-bordered">
													<tbody> 
														...
														<tr>         
															<td width="15%">파일키</td>
															<td>
																<input type="text" name="filterFileKey" id="filterFileKey" value="" class="form-control required">
															</td>
															<td width="15%">메모</td>
															<td>
 		...
 		if (jQuery().dataTable) {
			...
			table.dataTable({
				...
				"ajax" : {
					"url":'${context}/ax/netexport/list',
				   	...
				   	"data" :  function(param) {
						...
						param.file_key = $('#filterFileKey').val();
			    ...
			    "buttons": [
				                  ...
				                  bom: true,
				                  exportOptions: {
					                columns: [1,2,3,4,10,11,12,13,14,15,16],
				                      modifier: {
				                          search: 'applied',
				                          order: 'applied'
				                      }
