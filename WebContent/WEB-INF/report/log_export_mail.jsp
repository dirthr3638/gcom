					...
					<div id="layout-container" style="width: 100%; height: 100%;">
						...
						<div class="ui-layout-center">
							<div id="panel-list" class="panel panel-default">
								<div class="panel-heading">
									<span class="title elipsis">
										<strong>메일로그</strong> <!-- panel title -->
									</span>
								</div>
...
//			var nsTr = $('tbody > td > .datables-td-detail').parents('tr')[0];
 	...
 	function viewMailFile(mail_no){ 		
 		$.ajax({      
	        type:"GET",  
	        url:'${context}/ax/report/mail/detail',
	        async: false,
	        data:{
	        	mail_no : mail_no,
	        	_ : $.now()
 		...
 		if (jQuery().dataTable) {
			...
			table.dataTable({
			    ...
			    "buttons": [
				                  ...
				                  bom: true,
				                  exportOptions: {
						                columns: [1,2,3,4,6,10,11,12,13,16,17],
