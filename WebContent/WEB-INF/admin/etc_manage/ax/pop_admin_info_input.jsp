	...
	<c:otherwise>
       <option value="-1">선택가능한 부서가 없습니다</option>
										...
										<div class="row">
											<div class="col-md-6" style="overflow: hidden;">
												<label>접속IP 1</label>
												<input type="text" class="form-control ip_address" value="${adminInfo.ipAddr}" id="admin_ip0" placeholder="192.168.1.1">
											</div>	
											<div class="col-md-6" style="overflow: hidden;">
												<label>접속IP 2</label>
												<input type="text" class="form-control ip_address" value="${adminInfo.ipAddr1}" id="admin_ip1" placeholder="192.168.1.1">
				                                <br />
											</div>	
										</div>										
