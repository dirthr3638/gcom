	...
	<body>
							...
							<div id="panel-2" class="panel panel-default">
								...
								<div class="panel-heading">
									<span class="title elipsis">
										<strong>포트/웹/메일정책 정보</strong> <!-- panel title -->
									</span>
								</div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				fn_policy_export_list('network')
			});
			
			function fn_policy_export_list(tabCode){
				
				$.ajax({      
			        type:"POST",  
			        url:'/ax/admin/policy/export',
			        async: false,
			        data:{
			        	tabCode : tabCode,
			        	_ : $.now()
