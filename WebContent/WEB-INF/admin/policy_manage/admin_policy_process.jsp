	...
	<body>
							...
							<div id="panel-2" class="panel panel-default">
								...
								<div class="panel-heading">
									<span class="title elipsis">
										<strong>프로세스 정보</strong> <!-- panel title -->
									</span>
								</div>
		...
		<script type="text/javascript">
			...
			function fn_open_reg_process_popup(code){
				...
				$.ajax({      
				    type:"POST",  
				    url:'${context}/admin/policy/process/register',
				    async: false,
				    data:{ 
				    	code : code,
				    	_ : $.now()
			...
			function delete_data(code){
				...
				$.ajax({      
				    type:"POST",  
				    url:'${context}/admin/policy/process/delete',
				    async: false,
				    data:{ 
				    	code : code,
				    	_ : $.now()
					...
					if (jQuery().dataTable) {
					    ...
					    "ordering" : false,
				 		...
				 		"columns": [{
							...
							data: "proNo" //삭제  
							,render : function(data,type,row) {
								return '<button type="button" id="btnDeletePolicy" class="btn btn-xs btn-danger" onclick="javascript:fn_delete_process_policy_item('+ data +');"><i class="fa fa-trash" aria-hidden="true"></i>정책삭제</button>';
							}
						}],  
						"pageLength": 20,
						"iDisplayLength": 20,
