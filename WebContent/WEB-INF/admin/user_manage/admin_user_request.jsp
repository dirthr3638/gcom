 		...
 		if (jQuery().dataTable) {
			...
			table.dataTable({
				...
				"columns": [{
					...
					data: "oldPolicy.waterMarkType",
					"orderable": false	//기존 워터적용코드
				}, {
					data: "oldPolicy.waterMarkEndDate",
					"orderable": false	//기존 워터마크적용일시
				}, {
