	...
	<table class="table table-bordered">
		<tr>
			...
			<td class="center-cell" style="vertical-align: middle;">
				...
				<% } else { %>
					<label class="radio nomargin-top nomargin-bottom">
						<input type="radio" name="radio_net_port_block" value="Y" checked /><i></i> 허용
					</label>
					<label class="radio nomargin-top nomargin-bottom">
						<input type="radio" name="radio_net_port_block" value="N" /><i></i> 차단
					</label>
				<% } %>
			</td>
			...
			<td class="center-cell" style="vertical-align: middle;">
				...
				<% } else { %>
					<input type="text" id="att_net_port_type" name="att_net_port_type" class="form-control" value="Y" disabled />
				<% } %>
			</td>
		</tr>
	</table>
