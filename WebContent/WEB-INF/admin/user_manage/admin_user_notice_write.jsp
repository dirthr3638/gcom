											...
											<div class="fl_left">
												...
												<div class="input-group m-b-xxs" style="max-width: 300px;">
													<span class="input-group-btn">
						                             ...
						                             <input type="text" class="form-control" id="att_file_upload_view" name="att_file_upload_view" value="${view_file_nm}" disabled>
							                     </div>
												
												<div id="uploadPer">
									    		</div>
									    		
									    		<input type="text" id="att_upload_save_filename" class="hidden" value="${save_file_nm}">
						 						<input type="text" id="att_upload_view_filename" class="hidden" value="${view_file_nm}">
						 						<input type="text" id="att_upload_filepath" class="hidden" value="${att_file_path}">
											</div>
											<div class="fl_right">
