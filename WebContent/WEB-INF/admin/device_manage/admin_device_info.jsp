										...
										<div class="col-md-12">
											<div class="aside-tabs">
												<ul class="nav nav-tabs nav-top-border">
													...
													<li><a href="#usb_block" data-toggle="tab" onClick="javascript:fn_get_tab_content('usb_block');"><i class="fa fa-usb" title="USB 차단 현황"></i>비인가 USB차단현황</a></li>
												</ul>
