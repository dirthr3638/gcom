...
<% 
	String code = request.getAttribute("group").toString();
	List<HashMap<String, Object>> list = (List<HashMap<String, Object>>)request.getAttribute("userPolicyDetail");
	int list_cnt = list == null? 0 : list.size();
%>
<div id="modalPolicyDetail" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="margin-top: 10%;">
