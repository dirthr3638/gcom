...
@WebServlet("/admin/policy/website/delete")
public class axAdminPolicyWebsiteDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public axAdminPolicyWebsiteDelete() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String siteNo = request.getParameter("code").toString();
    	
    	HashMap<String, Object> param = new HashMap<String, Object>();
    	param.put("site_no", siteNo);
    	
    	deleteAdminAction action = new deleteAdminAction();
		HashMap<String, Object> data =  new HashMap<String, Object>();
		try {
			data = action.daletePolicyWebsiteData(param);
