...
@WebServlet("/ax/admin/policy/network/list")
public class axAdminPolicyNetWorkListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axAdminPolicyNetWorkListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> data = action.getPolicyNetworkList(map);
