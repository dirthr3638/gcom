...
@WebServlet("/ax/userinfo/list")
public class axUserInfoListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axUserInfoListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> data = action.getUserInfoList(map);
