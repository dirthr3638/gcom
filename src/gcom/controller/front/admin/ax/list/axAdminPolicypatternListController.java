...
@WebServlet("/ax/admin/policy/pattern/list")
public class axAdminPolicypatternListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axAdminPolicypatternListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> data = action.getPolicyPatternList(map);
