...
@WebServlet("/ax/admin/policy/process/list")
public class axAdminPolicyProcessListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public axAdminPolicyProcessListController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> data = action.getPolicyProcessList(map);
