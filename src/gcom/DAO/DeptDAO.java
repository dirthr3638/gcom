...
+ "(parent, leaf, depth, name, short_name, valid, child_count, recent_no, min_child_no, max_child_no) "
+ "VALUES ( "
+ "?, "
+ "1, "
+ "?, "
...
+ ") ";
	...
	public HashMap<String, Object> removeDeptInfo(int deptNo){
		...
		try{
			...
			//사용자 존재 체크
			pstmt=con.prepareStatement("SELECT COUNT(*) AS cnt FROM user_info WHERE dept_no = ? ");
